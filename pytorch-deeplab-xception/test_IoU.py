...
from dataloaders.datasets.crack_images import ValCrackImagesForSegmentation
...
python test_IoU.py --backbone resnet  --workers 4 \
    --use-sbd --batch-size 1 --gpu-ids 0 --checkname deeplab-resnet --dataset customed
'''

DEVICE = torch.device("cuda:0" if torch.cuda.is_available() else "cpu")
MODEL_DIR = 'run/EWSHM/exp2/checkpoint.pth.tar'
TEST_DIR = '/home/aicenter/Documents/hsu/data/EWSHM/exp2_test/'
...
if __name__ == "__main__":
    ...
    dataset_test = ValCrackImagesForSegmentation(TEST_DIR)
